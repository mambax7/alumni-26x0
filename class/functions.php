...
class AlumniFunctions
{

    public static function alumni_ShowImg()
    {
    ...
    public static function alumni_ShowImg2()
    {
        global $moduleDirName;
     ...
     * @return string
     */
    public static function alumni_convertorderbyin($orderby)
    {
        switch (trim($orderby)) {
            case 'nameA':
                $orderby = 'lname ASC';
     ...
     * @return string
     */
    public static function alumni_convertorderbytrans($orderby)
    {
        global $mainLang;
     ...
     * @return string
     */
    public static function alumni_convertorderbyout($orderby)
    {
        if ($orderby == 'lname ASC') {
            $orderby = 'nameA';
        }
     ...
     * @return string
     */
    public static function alumni_newlinkgraphic($cid)
    {
        global $moduleDirName;
    ...
    public static function alumni_filechecks()
    {
...
//        $photohighdir  = XOOPS_ROOT_PATH . '/modules/' . $xoopsModule->getVar('dirname') . '/photo/midsize';
        ...
        $grad_photo_dir   = XOOPS_ROOT_PATH . '/uploads/' . $xoopsModule->getVar('dirname') . '/photos/grad_photo';
        $now_photo_dir    = XOOPS_ROOT_PATH . '/uploads/' . $xoopsModule->getVar('dirname') . '/photos/now_photo';
        $school_photo_dir = XOOPS_ROOT_PATH . '/uploads/' . $xoopsModule->getVar('dirname') . '/photos/school_photos';
