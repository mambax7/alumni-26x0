    ...
    <tr>
        <td class="odd">
            <table border="1" style="width:100%;">
                <tr>
                    <td class="head" align="center"><{$front_intro}></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <table border="1" style="width:75%;" align="center">
            ...
            <td class="even" align="center">
                <table border="0" style="width:100%;" align="center">
                    <form name='search' id='search' action='search.php' method='post' onsubmit='return xoopsFormValidate_search();'>
                        ...
                        <td width='15%' align="center"><br/><b><{$search_listings}></b></td>
                        </tr>
                        <tr>
		...
		<option value='exact'><{$exact_match}></option>
                        ...
                        <tr>
                            ...
                            <td align="center"> <{$bycategory}><br/><{$category_select}><br/></td>
                        </tr>

                        <td align="center"><input type='submit' class='formButton' name='submit' id='submit' value='Search'/></td>
                        </tr>
        ...
        <td class="odd">
            <table border="0" style="width:100%;">
                ...
                <tr>
                    <td>
                <tr>
                    <td class="even" align="center"><br/><{$total_listings}><br/><{$total_confirm}></td>
                </tr>
            </table>
        </td>
    </tr>
