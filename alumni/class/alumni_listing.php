...
class alumni_listing extends XoopsObject
{
    ...
    public function getAdminForm($action = false)
    {
		...
		$title = $this->isNew() ? sprintf(_AM_ALUMNI_ADD_LINK) : sprintf(_AM_ALUMNI_LISTING_EDIT);
	...
	$form->addElement(new Xoops\Form\Label(_AM_ALUMNI_SUBMITTER, $xoops->user->uname()));
        ...
        $form->addElement(new Xoops\Form\Label(_AM_ALUMNI_CAT, $category_select), true);
	...
	$form->addElement(new Xoops\Form\Editor(_AM_ALUMNI_ACTIVITIES, 'activities', $editor_configs), false);
		...
		$editor_configs['rows'] = 6;
		$editor_configs['cols'] = 8;
	$form->addElement(new Xoops\Form\Editor(_AM_ALUMNI_EXTRAINFO, 'extrainfo', $editor_configs), false);

		$photo_old = $this->getVar("photo") ? $this->getVar("photo") : '';
		$uploadirectory_photo = XOOPS_ROOT_PATH."/modules/alumni/photos/grad_photo";
		$imgtray_photo = new Xoops\Form\ElementTray(_AM_ALUMNI_PHOTO,'<br />');
		$imgpath_photo = sprintf(_AM_ALUMNI_FORMIMAGE_PATH, $uploadirectory_photo);
		$fileseltray_photo = new Xoops\Form\ElementTray('','<br />');
 		$fileseltray_photo->addElement(new Xoops\Form\File(_AM_ALUMNI_FORMUPLOAD , "photo", $xoops->getModuleConfig("alumni_photomax")),false);

 		if ($photo_old) {
		$fileseltray_photo->addElement(new Xoops\Form\Label(_AM_ALUMNI_GRAD_PIC,'<a href="../photos/grad_photo/'.$photo_old.'">'.$photo_old.'</a>', false));
		$imgtray_checkbox = new Xoops\Form\Checkbox('', 'del_photo', 0);
		$imgtray_checkbox->addOption(1, _AM_ALUMNI_DELPICT);
	...
	$form->addElement(new Xoops\Form\Hidden("photo_old", $photo_old));
		...
		$imgtray_photo2 = new Xoops\Form\ElementTray(_AM_ALUMNI_PHOTO2,'<br />');
		$imgpath_photo2 = sprintf(_AM_ALUMNI_FORMIMAGE_PATH, $uploadirectory_photo2);
		$fileseltray_photo2 = new Xoops\Form\ElementTray('','<br />');
		$fileseltray_photo2->addElement(new Xoops\Form\File(_AM_ALUMNI_FORMUPLOAD , "photo2", $xoops->getModuleConfig("alumni_photomax")),false);

		if ($photo_old) {
		$fileseltray_photo2->addElement(new Xoops\Form\Label(_AM_ALUMNI_NOW_PIC,'<a href="../photos/now_photo/'.$photo2_old.'">'.$photo2_old.'</a>', false));
			

		$imgtray_checkbox2 = new Xoops\Form\Checkbox('', 'del_photo2', 0);
		$imgtray_checkbox2->addOption(1, _AM_ALUMNI_DELPICT);
	...
	$form->addElement(new Xoops\Form\Button("", "submit", _AM_ALUMNI_SUBMIT, "submit"));
	return $form;
	}
	...
	$myts = MyTextSanitizer::getInstance();
		...
		$title = $this->isNew() ? sprintf(_ALUMNI_ADD_LINK_MOD) : sprintf(_ALUMNI_LISTING_EDIT_MOD);
		} else {
		$title = $this->isNew() ? sprintf(_ALUMNI_ADD_LINK) : sprintf(_ALUMNI_LISTING_EDIT);
		}
	...
	$form->addElement(new Xoops\Form\Label(_ALUMNI_SUBMITTER, $xoops->user->uname()));
        ...
        $form->addElement(new Xoops\Form\Label(_ALUMNI_CAT, $category_select), true);
        ...
        $form->addElement(new Xoops\Form\Hidden("school", $cat_name));
	$form->addElement(new Xoops\Form\Text(_ALUMNI_NAME, "name", 50, 255, $this->getVar("name")), true);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_MNAME, "mname", 50, 255, $this->getVar("mname")), false);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_LNAME, "lname", 50, 255, $this->getVar("lname")), true);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_YEAR2, "year", 50, 255, $this->getVar("year")), true);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_STUDIES, "studies", 50, 255, $this->getVar("studies")), false);
		$activities = $this->getVar("activities",'e') ? $this->getVar("activities",'e') : '';
		$editor_configs=array();
		$editor_configs['name'] = 'activities';
		$editor_configs['value'] = ($activities);
	...
	$form->addElement(new Xoops\Form\Editor(_ALUMNI_ACTIVITIES, 'activities', $editor_configs), false);
		$extrainfo = $this->getVar("extrainfo",'e') ? $this->getVar("extrainfo",'e') : '';
		$editor_configs=array();
		$editor_configs['name'] = 'extrainfo';
		$editor_configs['value'] = $extrainfo;
	...
	$form->addElement(new Xoops\Form\Editor(_ALUMNI_EXTRAINFO, 'extrainfo', $editor_configs), false);
		$photo_old = $this->getVar("photo") ? $this->getVar("photo") : '';
		$uploadirectory_photo = XOOPS_ROOT_PATH."/modules/alumni/photos/grad_photo";
		$imgtray_photo = new Xoops\Form\ElementTray(_ALUMNI_GRAD_PIC,'<br />');
		$imgpath_photo = sprintf(_ALUMNI_FORMIMAGE_PATH, $uploadirectory_photo);
		$fileseltray_photo = new Xoops\Form\ElementTray('','<br />');
		$fileseltray_photo->addElement(new Xoops\Form\File(_ALUMNI_FORMUPLOAD , "photo", $xoops->getModuleConfig("alumni_photomax")),false);

		if ($photo_old) {
		$fileseltray_photo->addElement(new Xoops\Form\Label(_ALUMNI_CURRENT_GRAD_PIC,'<a href="photos/grad_photo/'.$photo_old.'">'.$photo_old.'</a>', false));
		$imgtray_checkbox = new Xoops\Form\Checkbox('', 'del_photo', 0);
		$imgtray_checkbox->addOption(1, _ALUMNI_DELPICT);
		$fileseltray_photo->addElement($imgtray_checkbox);
		}
		$imgtray_photo->addElement($fileseltray_photo);
	$form->addElement($imgtray_photo);
	$form->addElement(new Xoops\Form\Hidden("photo_old", $photo_old));
		...
		$photo2_old = $this->getVar("photo2") ? $this->getVar("photo2") : '';
		$uploadirectory_photo2 = XOOPS_ROOT_PATH."/modules/alumni/photos/now_photo";
		$imgtray_photo2 = new Xoops\Form\ElementTray(_ALUMNI_NOW_PIC,'<br />');
		$imgpath_photo2 = sprintf(_ALUMNI_FORMIMAGE_PATH, $uploadirectory_photo2);
		$fileseltray_photo2 = new Xoops\Form\ElementTray('','<br />');
		$fileseltray_photo2->addElement(new Xoops\Form\File(_ALUMNI_FORMUPLOAD , "photo2", $xoops->getModuleConfig("alumni_photomax")),false);

		if ($photo_old) {
		$fileseltray_photo2->addElement(new Xoops\Form\Label(_ALUMNI_CURRENT_NOW_PIC,'<a href="photos/now_photo/'.$photo2_old.'">'.$photo2_old.'</a>', false));
		$imgtray_checkbox2 = new Xoops\Form\Checkbox('', 'del_photo2', 0);
		$imgtray_checkbox2->addOption(1, _ALUMNI_DELPICT);
		$fileseltray_photo2->addElement($imgtray_checkbox2);
		}
		$imgtray_photo2->addElement($fileseltray_photo2);
	$form->addElement($imgtray_photo2);
	...
	$form->addElement(new Xoops\Form\Text(_ALUMNI_EMAIL, "email", 50, 255, $this->getVar("email")), true);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_OCC, "occ", 50, 255, $this->getVar("occ")), false);
	$form->addElement(new Xoops\Form\Text(_ALUMNI_TOWN, "town", 50, 255, $this->getVar("town")), false);
	...
	$form->addElement(new Xoops\Form\Hidden("op", "save_listing"));
	$form->addElement(new Xoops\Form\Button("", "submit", _ALUMNI_SUBMIT, "submit"));
	return $form;
      }
...
class AlumniAlumni_listingHandler extends XoopsPersistableObjectHandler
{
	...
	if (!is_object($listingObj)) return false;
