...
<{*<{if $sort_active == 'nameD'}>"assets/images/down_active.gif"" /><{else}>"assets/images/down.gif" /><{/if}><{$lang_date}> (<a href="categories.php?cid=<{$cat}>&orderby=dateA"><img title="<{$lang_dateold}>" style="<{$imgstyle}>" src=*}>
