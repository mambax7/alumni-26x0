...
function PrintAlum($lid=0)
{
    ...
    global $xoopsConfig, $xoopsUser, $xoopsDB, $xoopsModuleConfig, $useroffset, $myts, $xoopsLogger, $mydirname, $main_lang, $xoops;
...
echo "</table><table width=\"100%\" border=0 valign=top>";
	if ($photo) {
		echo "<tr><td width=\"40%\" valign=\"top\"><b>"._ALUMNI_GPHOTO."</b><br /><br /><img src=\"photos/grad_photo/$photo\" width='125' border=0></td>";
	}

	if ($photo2) {
		echo "<td width=\"60%\" valign=\"top\"><b>"._ALUMNI_RPHOTO."</b><br /><br />&nbsp;&nbsp;&nbsp;<img src=\"photos/now_photo/$photo2\" width='125' border=0></td></tr>";
	}
